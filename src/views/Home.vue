...
export default {
  ...
  methods: {
    loginHandler() {
      window.location = `https://accounts.spotify.com/authorize?response_type=token&redirect_uri=https://fierce-citadel-17311.herokuapp.com%2Fauth&scope=user-read-private%20user-library-read%20user-library-modify%20playlist-read-private%20user-read-recently-played%20user-follow-modify%20user-read-playback-position%20user-follow-read&client_id=7f7858ab81324701ada54b47514fa0a6`;
    },
  },
};
</script>
...
.bg-img::after {
  ...
  bottom: 0;
  right: 0;
  box-shadow: inset 0px 0px 300px 150px #222222;
}
.socmed-container {
  display: flex;
  gap: 1.5rem;
